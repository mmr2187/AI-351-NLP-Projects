...
| 1st/25-26 | [Filipino Hate Speech Detection using Transformers](https://github.com/jedld/filipino_hate_speech_detector) | This study evaluates transformer-based approaches for the detection of cyberbullying and hate speech in Filipino social media. | Mike Ignacio, Joseph Dayo | None |
| 1st/25-26 | [Integrating Sentiment Analysis of Business News Headlines from The Manila Times for Predicting the Philippine Stock Exchange Index (PSEi)](https://github.com/depipon/NLP_Project) | This study investigates the effect of sentiment scores derived from daily business news headlines on the prediction of the PSEi. | Janna De Veyra, Dave Pipon, Joseph Angelo Samonte | None |
| 1st/25-26 | [Modified Implementation of NLP Paper: Retrieval-Augmented Framework for LLM-Based Clinical Decision Support System by L. Garza, A. Kotal, M. A. Grasso, and E. Umucu](https://github.com/KristineNunez/RAG-LLM-CDSS) | This project implemented with modifications Garza, et al.’s RAG framework for an LLM-based Clinical Decision Support System (CDSS), using a subset of the MIMIC-III (Medical Information Mart for Intensive Care) dataset as external knowledge base. | Kristine Bernadette Q. Nunez | None |
